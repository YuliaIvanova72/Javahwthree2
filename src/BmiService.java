public class BmiService {
    ...
    public static int calculate(double weight, double heightInMeter) {
        double index = weight / (heightInMeter * heightInMeter);

        return (int) index;
    }
}
// индекс массы тела = m/h2, где m-масса тела в кг, h-рост в метрах
